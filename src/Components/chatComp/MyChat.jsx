...
import getChatName, { getChatImage } from "../../utils/chatName";
...
const MyChat = () => {
  ...
  return (
    <>
      <div className="p-6 w-full h-[7vh] font-semibold flex justify-between items-center  text-white">
        <h1 className="mr-2 whitespace-nowrap">My Chat</h1>
        <div
          className="flex items-center gap-2 border py-1 px-2 rounded-md cursor-pointer"
          ...
          <>
            ...
            {myChat?.map((chat) => {
              return (
                <div
                  key={chat?._id}
                  className={`w-full h-16 border-slate-500 border rounded-lg flex justify-start items-center p-2 font-semibold gap-2 hover:bg-orange-200/55 to-slate-800  via-slate-300   transition-all cursor-pointer ${
